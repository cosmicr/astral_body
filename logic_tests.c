...
bool test_lessv(uint16_t* offset)
{
    ...
    uint8_t var1 = read_heap((*offset)++);
    uint8_t var2 = read_heap((*offset)++);
...
bool test_obj_in_room(uint16_t* offset)
{
    ...
    obj = read_heap((*offset)++);
    room = read_heap((*offset)++);
...
bool test_posn(uint16_t* offset)
{
    ...
    uint8_t obj = read_heap((*offset)++);
    uint8_t x1 = read_heap((*offset)++);
    uint8_t y1 = read_heap((*offset)++);
    uint8_t x2 = read_heap((*offset)++);
    uint8_t y2 = read_heap((*offset)++);
...
bool test_compare_strings(uint16_t* offset)
{
    ...
    uint8_t str1 = read_heap((*offset)++);
    uint8_t str2 = read_heap((*offset)++);
